...
public class WebsiteVanityUrlUpdatedEvent {
  ...
  **/
  ...
  public WebsiteVanityUrlUpdatedEvent user(UserEventInfo user) {
    this.user = user;
    return this;
  }
   ...
   * @return user
  **/
  @ApiModelProperty(value = "User who has updated the url")
  ...
  public WebsiteVanityUrlUpdatedEvent vanityUrl(String vanityUrl) {
   ...
   * @return vanityUrl
  **/
  @ApiModelProperty(value = "New vanity url")
  ...
  **/
  ...
  public WebsiteVanityUrlUpdatedEvent createTime(OffsetDateTime createTime) {
  ...
  **/
  ...
  public WebsiteVanityUrlUpdatedEvent position(Integer position) {
  ...
  **/
  ...
  public WebsiteVanityUrlUpdatedEvent appId(String appId) {
    this.appId = appId;
    return this;
  }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, user, vanityUrl, eventName, flipdishEventId, createTime, position, appId);
  }
