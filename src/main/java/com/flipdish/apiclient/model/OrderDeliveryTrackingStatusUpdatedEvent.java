...
public class OrderDeliveryTrackingStatusUpdatedEvent {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(eventName, description, order, deliveryIntegrationName, deliveryErrorMessage, flipdishEventId, createTime, position, appId, orgId, ipAddress);
  }
