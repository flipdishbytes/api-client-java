...
public class MenuSectionItem {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(menuItemId, actualPrice, menuItemOptionSets, dailySpecialHours, publicId, metadata, name, description, spicinessRating, price, displayOrder, alcohol, isAvailable, cellLayoutType, disableVouchers, imageUrl);
  }
