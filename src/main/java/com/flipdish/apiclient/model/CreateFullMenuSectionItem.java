...
public class CreateFullMenuSectionItem {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(menuItemOptionSets, metadata, taxRateName, name, description, spicinessRating, price, displayOrder, alcohol, isAvailable, cellLayoutType, disableVouchers, imageUrl);
  }
