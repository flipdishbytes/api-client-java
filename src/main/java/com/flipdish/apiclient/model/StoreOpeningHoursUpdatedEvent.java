...
public class StoreOpeningHoursUpdatedEvent {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(eventName, storeId, storeGroupId, user, deliveryType, businessHoursPeriodOld, businessHoursPeriod, description, flipdishEventId, createTime, position, appId);
  }
