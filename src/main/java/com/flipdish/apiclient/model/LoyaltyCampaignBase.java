...
public class LoyaltyCampaignBase {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(ordersBeforeReceivingVoucher, percentDiscountAmount, voucherValidPeriodDays, includeDeliveryFee, autoApplyResultingVouchers, includeExistingOrders, isEnabled, storeIds);
  }
