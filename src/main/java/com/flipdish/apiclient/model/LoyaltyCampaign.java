...
public class LoyaltyCampaign {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(campaignId, statistics, stores, ordersBeforeReceivingVoucher, percentDiscountAmount, voucherValidPeriodDays, includeDeliveryFee, autoApplyResultingVouchers, includeExistingOrders, isEnabled, storeIds);
  }
