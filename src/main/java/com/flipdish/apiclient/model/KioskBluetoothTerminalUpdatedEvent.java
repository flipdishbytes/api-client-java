...
public class KioskBluetoothTerminalUpdatedEvent {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(deviceId, bluetoothTerminalType, bluetoothTerminalSerialNumber, bluetoothTerminalStatus, user, eventName, flipdishEventId, createTime, position, appId);
  }
