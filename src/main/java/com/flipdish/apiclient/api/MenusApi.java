...
public class MenusApi {
     ...
     * @param hide  (required)
     * @param undoAfter  (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call menusShowHideBulkItemsCall(Integer menuId, List<MenuElementHide> menuElements, Boolean hide, Double undoAfter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call menusShowHideBulkItemsValidateBeforeCall(Integer menuId, List<MenuElementHide> menuElements, Boolean hide, Double undoAfter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (hide == null) {
            throw new ApiException("Missing the required parameter 'hide' when calling menusShowHideBulkItems(Async)");
        }
        
        // verify the required parameter 'undoAfter' is set
        if (undoAfter == null) {
            throw new ApiException("Missing the required parameter 'undoAfter' when calling menusShowHideBulkItems(Async)");
        }
        

        com.squareup.okhttp.Call call = menusShowHideBulkItemsCall(menuId, menuElements, hide, undoAfter, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public RestApiArrayResultMenuElementEditResponse menusShowHideBulkItems(Integer menuId, List<MenuElementHide> menuElements, Boolean hide, Double undoAfter) throws ApiException {
        ApiResponse<RestApiArrayResultMenuElementEditResponse> resp = menusShowHideBulkItemsWithHttpInfo(menuId, menuElements, hide, undoAfter);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RestApiArrayResultMenuElementEditResponse> menusShowHideBulkItemsWithHttpInfo(Integer menuId, List<MenuElementHide> menuElements, Boolean hide, Double undoAfter) throws ApiException {
        com.squareup.okhttp.Call call = menusShowHideBulkItemsValidateBeforeCall(menuId, menuElements, hide, undoAfter, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call menusShowHideBulkItemsAsync(Integer menuId, List<MenuElementHide> menuElements, Boolean hide, Double undoAfter, final ApiCallback<RestApiArrayResultMenuElementEditResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = menusShowHideBulkItemsValidateBeforeCall(menuId, menuElements, hide, undoAfter, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<RestApiArrayResultMenuElementEditResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
