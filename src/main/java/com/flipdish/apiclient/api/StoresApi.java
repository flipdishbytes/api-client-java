...
public class StoresApi {
    ...
    /**
     * Build call for storesSetPropertyId
     * @param storeId  (required)
     * @param propertyId  (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call storesSetPropertyIdCall(Integer storeId, String propertyId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call storesSetPropertyIdValidateBeforeCall(Integer storeId, String propertyId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'storeId' is set
        if (storeId == null) {
            throw new ApiException("Missing the required parameter 'storeId' when calling storesSetPropertyId(Async)");
        }
        
        // verify the required parameter 'propertyId' is set
        if (propertyId == null) {
            throw new ApiException("Missing the required parameter 'propertyId' when calling storesSetPropertyId(Async)");
        }
        

        com.squareup.okhttp.Call call = storesSetPropertyIdCall(storeId, propertyId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Object storesSetPropertyId(Integer storeId, String propertyId) throws ApiException {
        ApiResponse<Object> resp = storesSetPropertyIdWithHttpInfo(storeId, propertyId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Object> storesSetPropertyIdWithHttpInfo(Integer storeId, String propertyId) throws ApiException {
        com.squareup.okhttp.Call call = storesSetPropertyIdValidateBeforeCall(storeId, propertyId, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call storesSetPropertyIdAsync(Integer storeId, String propertyId, final ApiCallback<Object> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = storesSetPropertyIdValidateBeforeCall(storeId, propertyId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
