...
public class StoresApi {
    ...
    /**
     * Build call for createStoreInProperty
     * @param storeGroupId  (required)
    ...
    public com.squareup.okhttp.Call createStoreInPropertyCall(Integer storeGroupId, String propertyId, StoreCreateBase store, Boolean autoAssignMenu, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v1.0/properties/{propertyId}/stores"
    ...
    private com.squareup.okhttp.Call createStoreInPropertyValidateBeforeCall(Integer storeGroupId, String propertyId, StoreCreateBase store, Boolean autoAssignMenu, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // verify the required parameter 'storeGroupId' is set
        if (storeGroupId == null) {
            throw new ApiException("Missing the required parameter 'storeGroupId' when calling createStoreInProperty(Async)");
        }
        
        // verify the required parameter 'propertyId' is set
        if (propertyId == null) {
            throw new ApiException("Missing the required parameter 'propertyId' when calling createStoreInProperty(Async)");
        }
        
        // verify the required parameter 'store' is set
        if (store == null) {
            throw new ApiException("Missing the required parameter 'store' when calling createStoreInProperty(Async)");
        }
    ...
    /**
     * Build call for getStoreDeliveryFeeConfig
     * @param storeId  (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getStoreDeliveryFeeConfigCall(Integer storeId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v1.0/stores/{storeId}/feeConfig/deliveryZones"
            .replaceAll("\\{" + "storeId" + "\\}", apiClient.escapeString(storeId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getStoreDeliveryFeeConfigValidateBeforeCall(Integer storeId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'storeId' is set
        if (storeId == null) {
            throw new ApiException("Missing the required parameter 'storeId' when calling getStoreDeliveryFeeConfig(Async)");
        }
        

        com.squareup.okhttp.Call call = getStoreDeliveryFeeConfigCall(storeId, progressListener, progressRequestListener);
        return call;
     ...
     * 
     * @param storeId  (required)
     * @return RestApiArrayResultStoreDeliveryZoneFeeConfig
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public RestApiArrayResultStoreDeliveryZoneFeeConfig getStoreDeliveryFeeConfig(Integer storeId) throws ApiException {
        ApiResponse<RestApiArrayResultStoreDeliveryZoneFeeConfig> resp = getStoreDeliveryFeeConfigWithHttpInfo(storeId);
        return resp.getData();
    }
     ...
     * 
     * @param storeId  (required)
     * @return ApiResponse&lt;RestApiArrayResultStoreDeliveryZoneFeeConfig&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RestApiArrayResultStoreDeliveryZoneFeeConfig> getStoreDeliveryFeeConfigWithHttpInfo(Integer storeId) throws ApiException {
        com.squareup.okhttp.Call call = getStoreDeliveryFeeConfigValidateBeforeCall(storeId, null, null);
        Type localVarReturnType = new TypeToken<RestApiArrayResultStoreDeliveryZoneFeeConfig>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getStoreDeliveryFeeConfigAsync(Integer storeId, final ApiCallback<RestApiArrayResultStoreDeliveryZoneFeeConfig> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getStoreDeliveryFeeConfigValidateBeforeCall(storeId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<RestApiArrayResultStoreDeliveryZoneFeeConfig>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param searchQuery  (optional)
     * @param salesChannelType  (optional)
     * @param excludeUnpublished  (optional)
     * @param page  (optional)
     * @param limit  (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getStoresByAppIdCall(String appId, String searchQuery, String salesChannelType, Boolean excludeUnpublished, Integer page, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (salesChannelType != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("salesChannelType", salesChannelType));
        if (excludeUnpublished != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("excludeUnpublished", excludeUnpublished));
        if (page != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("page", page));
        if (limit != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("limit", limit));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getStoresByAppIdValidateBeforeCall(String appId, String searchQuery, String salesChannelType, Boolean excludeUnpublished, Integer page, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getStoresByAppIdCall(appId, searchQuery, salesChannelType, excludeUnpublished, page, limit, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public RestApiPaginationResultStore getStoresByAppId(String appId, String searchQuery, String salesChannelType, Boolean excludeUnpublished, Integer page, Integer limit) throws ApiException {
        ApiResponse<RestApiPaginationResultStore> resp = getStoresByAppIdWithHttpInfo(appId, searchQuery, salesChannelType, excludeUnpublished, page, limit);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RestApiPaginationResultStore> getStoresByAppIdWithHttpInfo(String appId, String searchQuery, String salesChannelType, Boolean excludeUnpublished, Integer page, Integer limit) throws ApiException {
        com.squareup.okhttp.Call call = getStoresByAppIdValidateBeforeCall(appId, searchQuery, salesChannelType, excludeUnpublished, page, limit, null, null);
        Type localVarReturnType = new TypeToken<RestApiPaginationResultStore>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getStoresByAppIdAsync(String appId, String searchQuery, String salesChannelType, Boolean excludeUnpublished, Integer page, Integer limit, final ApiCallback<RestApiPaginationResultStore> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getStoresByAppIdValidateBeforeCall(appId, searchQuery, salesChannelType, excludeUnpublished, page, limit, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<RestApiPaginationResultStore>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    /**
     * Build call for putStoreDeliveryFeeConfig
     * @param storeId  (required)
     * @param feeConfigUpdateRequest  (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call putStoreDeliveryFeeConfigCall(Integer storeId, StoreDeliveryZoneFeeConfigUpdateRequest feeConfigUpdateRequest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = feeConfigUpdateRequest;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call putStoreDeliveryFeeConfigValidateBeforeCall(Integer storeId, StoreDeliveryZoneFeeConfigUpdateRequest feeConfigUpdateRequest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'storeId' is set
        if (storeId == null) {
            throw new ApiException("Missing the required parameter 'storeId' when calling putStoreDeliveryFeeConfig(Async)");
        }
        
        // verify the required parameter 'feeConfigUpdateRequest' is set
        if (feeConfigUpdateRequest == null) {
            throw new ApiException("Missing the required parameter 'feeConfigUpdateRequest' when calling putStoreDeliveryFeeConfig(Async)");
        }
        

        com.squareup.okhttp.Call call = putStoreDeliveryFeeConfigCall(storeId, feeConfigUpdateRequest, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void putStoreDeliveryFeeConfig(Integer storeId, StoreDeliveryZoneFeeConfigUpdateRequest feeConfigUpdateRequest) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> putStoreDeliveryFeeConfigWithHttpInfo(Integer storeId, StoreDeliveryZoneFeeConfigUpdateRequest feeConfigUpdateRequest) throws ApiException {
        com.squareup.okhttp.Call call = putStoreDeliveryFeeConfigValidateBeforeCall(storeId, feeConfigUpdateRequest, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call putStoreDeliveryFeeConfigAsync(Integer storeId, StoreDeliveryZoneFeeConfigUpdateRequest feeConfigUpdateRequest, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = putStoreDeliveryFeeConfigValidateBeforeCall(storeId, feeConfigUpdateRequest, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call setPropertyIdCall(Integer storeId, String propertyId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v1.0/stores/{storeId}/propertyId/{propertyId}"
            .replaceAll("\\{" + "storeId" + "\\}", apiClient.escapeString(storeId.toString()))
            .replaceAll("\\{" + "propertyId" + "\\}", apiClient.escapeString(propertyId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call setPropertyIdValidateBeforeCall(Integer storeId, String propertyId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'storeId' is set
        if (storeId == null) {
            throw new ApiException("Missing the required parameter 'storeId' when calling setPropertyId(Async)");
        }
        
        // verify the required parameter 'propertyId' is set
        if (propertyId == null) {
            throw new ApiException("Missing the required parameter 'propertyId' when calling setPropertyId(Async)");
        }
        

        com.squareup.okhttp.Call call = setPropertyIdCall(storeId, propertyId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void setPropertyId(Integer storeId, String propertyId) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> setPropertyIdWithHttpInfo(Integer storeId, String propertyId) throws ApiException {
        com.squareup.okhttp.Call call = setPropertyIdValidateBeforeCall(storeId, propertyId, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call setPropertyIdAsync(Integer storeId, String propertyId, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = setPropertyIdValidateBeforeCall(storeId, propertyId, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
    ...
    public com.squareup.okhttp.Call setStoreCollectionSettingsCall(Integer storeId, StoreCollectionSettings settings, Boolean inheritFromProperty, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v1.0/stores/{storeId}/collectionsettings"
            .replaceAll("\\{" + "storeId" + "\\}", apiClient.escapeString(storeId.toString()));
    ...
    private com.squareup.okhttp.Call setStoreCollectionSettingsValidateBeforeCall(Integer storeId, StoreCollectionSettings settings, Boolean inheritFromProperty, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // verify the required parameter 'storeId' is set
        if (storeId == null) {
            throw new ApiException("Missing the required parameter 'storeId' when calling setStoreCollectionSettings(Async)");
        }
        
        // verify the required parameter 'settings' is set
        if (settings == null) {
            throw new ApiException("Missing the required parameter 'settings' when calling setStoreCollectionSettings(Async)");
        }
    ...
    /**
     * Build call for supportedSalesChannelsTypes
     * @param propertyId  (required)
     * @param storeId  (required)
     * @param salesChannelTypes  (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call supportedSalesChannelsTypesCall(String propertyId, Integer storeId, List<String> salesChannelTypes, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = salesChannelTypes;

        // create path and map variables
        String localVarPath = "/api/v1.0/properties/{propertyId}/stores/{storeId}/supportedSalesChannels"
            .replaceAll("\\{" + "propertyId" + "\\}", apiClient.escapeString(propertyId.toString()))
            .replaceAll("\\{" + "storeId" + "\\}", apiClient.escapeString(storeId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call supportedSalesChannelsTypesValidateBeforeCall(String propertyId, Integer storeId, List<String> salesChannelTypes, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'propertyId' is set
        if (propertyId == null) {
            throw new ApiException("Missing the required parameter 'propertyId' when calling supportedSalesChannelsTypes(Async)");
        }
        
        // verify the required parameter 'storeId' is set
        if (storeId == null) {
            throw new ApiException("Missing the required parameter 'storeId' when calling supportedSalesChannelsTypes(Async)");
        }
        
        // verify the required parameter 'salesChannelTypes' is set
        if (salesChannelTypes == null) {
            throw new ApiException("Missing the required parameter 'salesChannelTypes' when calling supportedSalesChannelsTypes(Async)");
        }
        

        com.squareup.okhttp.Call call = supportedSalesChannelsTypesCall(propertyId, storeId, salesChannelTypes, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void supportedSalesChannelsTypes(String propertyId, Integer storeId, List<String> salesChannelTypes) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> supportedSalesChannelsTypesWithHttpInfo(String propertyId, Integer storeId, List<String> salesChannelTypes) throws ApiException {
        com.squareup.okhttp.Call call = supportedSalesChannelsTypesValidateBeforeCall(propertyId, storeId, salesChannelTypes, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call supportedSalesChannelsTypesAsync(String propertyId, Integer storeId, List<String> salesChannelTypes, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = supportedSalesChannelsTypesValidateBeforeCall(propertyId, storeId, salesChannelTypes, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void updateStoreAddressForm(Integer storeId, StoreAddressForm address) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> updateStoreAddressFormWithHttpInfo(Integer storeId, StoreAddressForm address) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateStoreAddressFormAsync(Integer storeId, StoreAddressForm address, final ApiCallback<Void> callback) throws ApiException {
