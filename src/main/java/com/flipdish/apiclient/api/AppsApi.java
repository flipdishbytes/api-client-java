...
public class AppsApi {
    ...
    /**
     * Build call for createAppInOrg
     * @param orgId  (required)
     * @param createAppInOrgRequest  (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call createAppInOrgCall(String orgId, CreateAppInOrg createAppInOrgRequest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = createAppInOrgRequest;

        // create path and map variables
        String localVarPath = "/api/v1.0/orgs/{orgId}/apps"
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call createAppInOrgValidateBeforeCall(String orgId, CreateAppInOrg createAppInOrgRequest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'orgId' is set
        if (orgId == null) {
            throw new ApiException("Missing the required parameter 'orgId' when calling createAppInOrg(Async)");
        }
        
        // verify the required parameter 'createAppInOrgRequest' is set
        if (createAppInOrgRequest == null) {
            throw new ApiException("Missing the required parameter 'createAppInOrgRequest' when calling createAppInOrg(Async)");
        }
        

        com.squareup.okhttp.Call call = createAppInOrgCall(orgId, createAppInOrgRequest, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public RestApiResultApp createAppInOrg(String orgId, CreateAppInOrg createAppInOrgRequest) throws ApiException {
        ApiResponse<RestApiResultApp> resp = createAppInOrgWithHttpInfo(orgId, createAppInOrgRequest);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RestApiResultApp> createAppInOrgWithHttpInfo(String orgId, CreateAppInOrg createAppInOrgRequest) throws ApiException {
        com.squareup.okhttp.Call call = createAppInOrgValidateBeforeCall(orgId, createAppInOrgRequest, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call createAppInOrgAsync(String orgId, CreateAppInOrg createAppInOrgRequest, final ApiCallback<RestApiResultApp> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createAppInOrgValidateBeforeCall(orgId, createAppInOrgRequest, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<RestApiResultApp>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
