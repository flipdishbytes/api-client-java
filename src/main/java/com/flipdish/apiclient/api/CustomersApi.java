...
public class CustomersApi {
    ...
    /**
     * Build call for customersGetOptOutMarketingLink
     ...
     */
    public com.squareup.okhttp.Call customersGetOptOutMarketingLinkCall(String appId, Integer customerId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v1.0/{appId}/customers/{customerId}/opt-out-link"
    ...
    private com.squareup.okhttp.Call customersGetOptOutMarketingLinkValidateBeforeCall(String appId, Integer customerId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'appId' is set
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling customersGetOptOutMarketingLink(Async)");
        }
        
        // verify the required parameter 'customerId' is set
        if (customerId == null) {
            throw new ApiException("Missing the required parameter 'customerId' when calling customersGetOptOutMarketingLink(Async)");
        }
        

        com.squareup.okhttp.Call call = customersGetOptOutMarketingLinkCall(appId, customerId, progressListener, progressRequestListener);
        return call;
     ...
     */
    public Object customersGetOptOutMarketingLink(String appId, Integer customerId) throws ApiException {
        ApiResponse<Object> resp = customersGetOptOutMarketingLinkWithHttpInfo(appId, customerId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Object> customersGetOptOutMarketingLinkWithHttpInfo(String appId, Integer customerId) throws ApiException {
        com.squareup.okhttp.Call call = customersGetOptOutMarketingLinkValidateBeforeCall(appId, customerId, null, null);
     ...
     */
    public com.squareup.okhttp.Call customersGetOptOutMarketingLinkAsync(String appId, Integer customerId, final ApiCallback<Object> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = customersGetOptOutMarketingLinkValidateBeforeCall(appId, customerId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
