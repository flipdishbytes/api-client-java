...
public class CustomersApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getCustomersCall(String appId, String phoneNumber, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getCustomersValidateBeforeCall(String appId, String phoneNumber, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'appId' is set
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling getCustomers(Async)");
        }
        
        // verify the required parameter 'phoneNumber' is set
        if (phoneNumber == null) {
            throw new ApiException("Missing the required parameter 'phoneNumber' when calling getCustomers(Async)");
        }
        

        com.squareup.okhttp.Call call = getCustomersCall(appId, phoneNumber, progressListener, progressRequestListener);
        return call;
     ...
     * @param appId  (required)
     * @param phoneNumber  (required)
     * @return RestApiResultCustomers
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public RestApiResultCustomers getCustomers(String appId, String phoneNumber) throws ApiException {
        ApiResponse<RestApiResultCustomers> resp = getCustomersWithHttpInfo(appId, phoneNumber);
        return resp.getData();
    }
     ...
     * @param appId  (required)
     * @param phoneNumber  (required)
     * @return ApiResponse&lt;RestApiResultCustomers&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RestApiResultCustomers> getCustomersWithHttpInfo(String appId, String phoneNumber) throws ApiException {
        com.squareup.okhttp.Call call = getCustomersValidateBeforeCall(appId, phoneNumber, null, null);
        Type localVarReturnType = new TypeToken<RestApiResultCustomers>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getCustomersAsync(String appId, String phoneNumber, final ApiCallback<RestApiResultCustomers> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCustomersValidateBeforeCall(appId, phoneNumber, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<RestApiResultCustomers>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
