...
public class AppStoreDeveloperApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getAppStoreAppCall(String oauthAppId, String appStoreAppId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getAppStoreAppValidateBeforeCall(String oauthAppId, String appStoreAppId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'oauthAppId' is set
        if (oauthAppId == null) {
            throw new ApiException("Missing the required parameter 'oauthAppId' when calling getAppStoreApp(Async)");
        }
        ...
        com.squareup.okhttp.Call call = getAppStoreAppCall(oauthAppId, appStoreAppId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public AppStoreApp getAppStoreApp(String oauthAppId, String appStoreAppId) throws ApiException {
        ApiResponse<AppStoreApp> resp = getAppStoreAppWithHttpInfo(oauthAppId, appStoreAppId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<AppStoreApp> getAppStoreAppWithHttpInfo(String oauthAppId, String appStoreAppId) throws ApiException {
        com.squareup.okhttp.Call call = getAppStoreAppValidateBeforeCall(oauthAppId, appStoreAppId, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getAppStoreAppAsync(String oauthAppId, String appStoreAppId, final ApiCallback<AppStoreApp> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getAppStoreAppValidateBeforeCall(oauthAppId, appStoreAppId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<AppStoreApp>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
