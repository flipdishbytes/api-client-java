...
public class AccountsApi {
    ...
    /**
     * Build call for accountsIsRecaptchaOn
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call accountsIsRecaptchaOnCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v1.0/accounts/recaptcha/check";
    ...
    private com.squareup.okhttp.Call accountsIsRecaptchaOnValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = accountsIsRecaptchaOnCall(progressListener, progressRequestListener);
        return call;
     ...
     */
    public void accountsIsRecaptchaOn() throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> accountsIsRecaptchaOnWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = accountsIsRecaptchaOnValidateBeforeCall(null, null);
        return apiClient.execute(call);
    }

    /**
     * [PRIVATE API] Temporary endpoint to return recaptcha FF (asynchronously)
     * 
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call accountsIsRecaptchaOnAsync(final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = accountsIsRecaptchaOnValidateBeforeCall(progressListener, progressRequestListener);
