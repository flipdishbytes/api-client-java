...
public class PayoutReportsApi {
    ...
    /**
     * Build call for payoutReport3ExportPayoutLedgerEntries
     * @param appId  (required)
     * @param bankAccountId  (required)
     * @param payoutId  (required)
     * @param stores  (optional)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call payoutReport3ExportPayoutLedgerEntriesCall(String appId, Integer bankAccountId, Integer payoutId, List<Integer> stores, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v1.0/{appId}/reporting/reports/payouts3/{bankAccountId}/{payoutId}/export/ledgerentries"
            .replaceAll("\\{" + "appId" + "\\}", apiClient.escapeString(appId.toString()))
            .replaceAll("\\{" + "bankAccountId" + "\\}", apiClient.escapeString(bankAccountId.toString()))
            .replaceAll("\\{" + "payoutId" + "\\}", apiClient.escapeString(payoutId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call payoutReport3ExportPayoutLedgerEntriesValidateBeforeCall(String appId, Integer bankAccountId, Integer payoutId, List<Integer> stores, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'appId' is set
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling payoutReport3ExportPayoutLedgerEntries(Async)");
        }
        
        // verify the required parameter 'bankAccountId' is set
        if (bankAccountId == null) {
            throw new ApiException("Missing the required parameter 'bankAccountId' when calling payoutReport3ExportPayoutLedgerEntries(Async)");
        }
        
        // verify the required parameter 'payoutId' is set
        if (payoutId == null) {
            throw new ApiException("Missing the required parameter 'payoutId' when calling payoutReport3ExportPayoutLedgerEntries(Async)");
        }
        

        com.squareup.okhttp.Call call = payoutReport3ExportPayoutLedgerEntriesCall(appId, bankAccountId, payoutId, stores, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public RestApiResultFileCreationResult payoutReport3ExportPayoutLedgerEntries(String appId, Integer bankAccountId, Integer payoutId, List<Integer> stores) throws ApiException {
        ApiResponse<RestApiResultFileCreationResult> resp = payoutReport3ExportPayoutLedgerEntriesWithHttpInfo(appId, bankAccountId, payoutId, stores);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RestApiResultFileCreationResult> payoutReport3ExportPayoutLedgerEntriesWithHttpInfo(String appId, Integer bankAccountId, Integer payoutId, List<Integer> stores) throws ApiException {
        com.squareup.okhttp.Call call = payoutReport3ExportPayoutLedgerEntriesValidateBeforeCall(appId, bankAccountId, payoutId, stores, null, null);
        Type localVarReturnType = new TypeToken<RestApiResultFileCreationResult>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call payoutReport3ExportPayoutLedgerEntriesAsync(String appId, Integer bankAccountId, Integer payoutId, List<Integer> stores, final ApiCallback<RestApiResultFileCreationResult> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = payoutReport3ExportPayoutLedgerEntriesValidateBeforeCall(appId, bankAccountId, payoutId, stores, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<RestApiResultFileCreationResult>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
