...
public class VouchersApi {
    ...
    /**
     * Build call for getVoucherByCode
     * @param appId  (required)
     * @param code  (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getVoucherByCodeCall(String appId, String code, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v1.0/{appId}/vouchers/code/{code}"
            .replaceAll("\\{" + "appId" + "\\}", apiClient.escapeString(appId.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getVoucherByCodeValidateBeforeCall(String appId, String code, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'appId' is set
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling getVoucherByCode(Async)");
        }
        
        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling getVoucherByCode(Async)");
        }
        

        com.squareup.okhttp.Call call = getVoucherByCodeCall(appId, code, progressListener, progressRequestListener);
        return call;
     ...
     * @param appId  (required)
     * @param code  (required)
     * @return RestApiResultVoucher
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public RestApiResultVoucher getVoucherByCode(String appId, String code) throws ApiException {
        ApiResponse<RestApiResultVoucher> resp = getVoucherByCodeWithHttpInfo(appId, code);
        return resp.getData();
    }
     ...
     * @param appId  (required)
     * @param code  (required)
     * @return ApiResponse&lt;RestApiResultVoucher&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RestApiResultVoucher> getVoucherByCodeWithHttpInfo(String appId, String code) throws ApiException {
        com.squareup.okhttp.Call call = getVoucherByCodeValidateBeforeCall(appId, code, null, null);
        Type localVarReturnType = new TypeToken<RestApiResultVoucher>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getVoucherByCodeAsync(String appId, String code, final ApiCallback<RestApiResultVoucher> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getVoucherByCodeValidateBeforeCall(appId, code, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<RestApiResultVoucher>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    /**
     * Build call for getVouchersByCustomerForApp
     * @param appId  (required)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getVouchersByCustomerForAppCall(String appId, Integer customerId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v1.0/vouchers/{appId}/customer/{customerId}"
            .replaceAll("\\{" + "appId" + "\\}", apiClient.escapeString(appId.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getVouchersByCustomerForAppValidateBeforeCall(String appId, Integer customerId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'appId' is set
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling getVouchersByCustomerForApp(Async)");
        }
        
        // verify the required parameter 'customerId' is set
        if (customerId == null) {
            throw new ApiException("Missing the required parameter 'customerId' when calling getVouchersByCustomerForApp(Async)");
        }
        

        com.squareup.okhttp.Call call = getVouchersByCustomerForAppCall(appId, customerId, progressListener, progressRequestListener);
        return call;
     ...
     * @param appId  (required)
     * @param customerId  (required)
     * @return RestApiArrayResultVoucherSummary
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public RestApiArrayResultVoucherSummary getVouchersByCustomerForApp(String appId, Integer customerId) throws ApiException {
        ApiResponse<RestApiArrayResultVoucherSummary> resp = getVouchersByCustomerForAppWithHttpInfo(appId, customerId);
        return resp.getData();
    }
     ...
     * @param appId  (required)
     * @param customerId  (required)
     * @return ApiResponse&lt;RestApiArrayResultVoucherSummary&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RestApiArrayResultVoucherSummary> getVouchersByCustomerForAppWithHttpInfo(String appId, Integer customerId) throws ApiException {
        com.squareup.okhttp.Call call = getVouchersByCustomerForAppValidateBeforeCall(appId, customerId, null, null);
        Type localVarReturnType = new TypeToken<RestApiArrayResultVoucherSummary>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getVouchersByCustomerForAppAsync(String appId, Integer customerId, final ApiCallback<RestApiArrayResultVoucherSummary> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getVouchersByCustomerForAppValidateBeforeCall(appId, customerId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<RestApiArrayResultVoucherSummary>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
