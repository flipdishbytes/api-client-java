...
public class CatalogItemsApi {
    ...
    /**
     * Build call for deleteCatalogItemImage
     * @param appId  (required)
     * @param catalogItemId  (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call deleteCatalogItemImageCall(String appId, String catalogItemId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v1.0/{appId}/catalog/items/{catalogItemId}/image"
            .replaceAll("\\{" + "appId" + "\\}", apiClient.escapeString(appId.toString()))
            .replaceAll("\\{" + "catalogItemId" + "\\}", apiClient.escapeString(catalogItemId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call deleteCatalogItemImageValidateBeforeCall(String appId, String catalogItemId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'appId' is set
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling deleteCatalogItemImage(Async)");
        }
        
        // verify the required parameter 'catalogItemId' is set
        if (catalogItemId == null) {
            throw new ApiException("Missing the required parameter 'catalogItemId' when calling deleteCatalogItemImage(Async)");
        }
        

        com.squareup.okhttp.Call call = deleteCatalogItemImageCall(appId, catalogItemId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void deleteCatalogItemImage(String appId, String catalogItemId) throws ApiException {
        deleteCatalogItemImageWithHttpInfo(appId, catalogItemId);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> deleteCatalogItemImageWithHttpInfo(String appId, String catalogItemId) throws ApiException {
        com.squareup.okhttp.Call call = deleteCatalogItemImageValidateBeforeCall(appId, catalogItemId, null, null);
        return apiClient.execute(call);
    }

    /**
     * Delete a CatalogItem Image (asynchronously)
     * [BETA - this endpoint is under development, do not use it in your production system]
     * @param appId  (required)
     * @param catalogItemId  (required)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call deleteCatalogItemImageAsync(String appId, String catalogItemId, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteCatalogItemImageValidateBeforeCall(appId, catalogItemId, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
    ...
    /**
     * Build call for uploadCatalogItemImage
     * @param appId  (required)
     * @param catalogItemId  (required)
     * @param image Catalog Item image (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call uploadCatalogItemImageCall(String appId, String catalogItemId, File image, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call uploadCatalogItemImageValidateBeforeCall(String appId, String catalogItemId, File image, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'appId' is set
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling uploadCatalogItemImage(Async)");
        }
        
        // verify the required parameter 'catalogItemId' is set
        if (catalogItemId == null) {
            throw new ApiException("Missing the required parameter 'catalogItemId' when calling uploadCatalogItemImage(Async)");
        }
        
        // verify the required parameter 'image' is set
        if (image == null) {
            throw new ApiException("Missing the required parameter 'image' when calling uploadCatalogItemImage(Async)");
        }
        

        com.squareup.okhttp.Call call = uploadCatalogItemImageCall(appId, catalogItemId, image, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public RestApiStringResult uploadCatalogItemImage(String appId, String catalogItemId, File image) throws ApiException {
        ApiResponse<RestApiStringResult> resp = uploadCatalogItemImageWithHttpInfo(appId, catalogItemId, image);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RestApiStringResult> uploadCatalogItemImageWithHttpInfo(String appId, String catalogItemId, File image) throws ApiException {
        com.squareup.okhttp.Call call = uploadCatalogItemImageValidateBeforeCall(appId, catalogItemId, image, null, null);
        Type localVarReturnType = new TypeToken<RestApiStringResult>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Upload a Catalog Item Image (asynchronously)
     * [BETA - this endpoint is under development, do not use it in your production system]
     * @param appId  (required)
     * @param catalogItemId  (required)
     * @param image Catalog Item image (required)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call uploadCatalogItemImageAsync(String appId, String catalogItemId, File image, final ApiCallback<RestApiStringResult> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = uploadCatalogItemImageValidateBeforeCall(appId, catalogItemId, image, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<RestApiStringResult>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
