...
public class MenuSectionsApi {
     ...
     * @param businessHoursPeriod Menu section active hours, note: DayOfWeek property will be overriden by the path parameter. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    /**
     * Set/update menu section availability hours. (asynchronously)
     * 
     * @param menuId Menu identifier (required)
     * @param menuSectionId Menu section identifier (required)
     * @param dayOfWeek Day of the  week (required)
     ...
     * @param menuId Menu identifier (required)
     * @param menuSectionId Menu section identifier (required)
     * @param menuSectionAvailability DisplayAlways, DisplayBasedOnTimes, DisplayAlwaysStartCollapsed, DisplayAlwaysStartCollapsedBasedOnTimes (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    /**
     * Create menu availability type (asynchronously)
     * 
     * @param menuId Menu identifier (required)
     * @param menuSectionId Menu section identifier (required)
     * @param menuSectionAvailability DisplayAlways, DisplayBasedOnTimes, DisplayAlwaysStartCollapsed, DisplayAlwaysStartCollapsedBasedOnTimes (required)
    ...
    public com.squareup.okhttp.Call menuSectionsSetItemDisplayOrdersCall(Integer menuId, Integer menuSectionId, MenuObjectDisplayOrders displayOrders, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v1.0/menus/{menuId}/sections/{menuSectionId}/sectionitemdisplayorders"
            .replaceAll("\\{" + "menuId" + "\\}", apiClient.escapeString(menuId.toString()))
            .replaceAll("\\{" + "menuSectionId" + "\\}", apiClient.escapeString(menuSectionId.toString()));
