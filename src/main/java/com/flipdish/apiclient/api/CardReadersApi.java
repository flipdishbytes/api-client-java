...
public class CardReadersApi {
     ...
     */
    public com.squareup.okhttp.Call authorizeStripeTerminalCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v1.0/cardreaders/authorize/stripe";
    ...
    private com.squareup.okhttp.Call authorizeStripeTerminalValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = authorizeStripeTerminalCall(progressListener, progressRequestListener);
        return call;
     ...
     */
    public RestApiResultStripeTerminalPrivateKey authorizeStripeTerminal() throws ApiException {
        ApiResponse<RestApiResultStripeTerminalPrivateKey> resp = authorizeStripeTerminalWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RestApiResultStripeTerminalPrivateKey> authorizeStripeTerminalWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = authorizeStripeTerminalValidateBeforeCall(null, null);
     ...
     */
    public com.squareup.okhttp.Call authorizeStripeTerminalAsync(final ApiCallback<RestApiResultStripeTerminalPrivateKey> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = authorizeStripeTerminalValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<RestApiResultStripeTerminalPrivateKey>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for authorizeStripeTerminal_0
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call authorizeStripeTerminal_0Call(String appId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call authorizeStripeTerminal_0ValidateBeforeCall(String appId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'appId' is set
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling authorizeStripeTerminal_0(Async)");
        }
        

        com.squareup.okhttp.Call call = authorizeStripeTerminal_0Call(appId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public RestApiResultStripeTerminalPrivateKey authorizeStripeTerminal_0(String appId) throws ApiException {
        ApiResponse<RestApiResultStripeTerminalPrivateKey> resp = authorizeStripeTerminal_0WithHttpInfo(appId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RestApiResultStripeTerminalPrivateKey> authorizeStripeTerminal_0WithHttpInfo(String appId) throws ApiException {
        com.squareup.okhttp.Call call = authorizeStripeTerminal_0ValidateBeforeCall(appId, null, null);
        Type localVarReturnType = new TypeToken<RestApiResultStripeTerminalPrivateKey>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call authorizeStripeTerminal_0Async(String appId, final ApiCallback<RestApiResultStripeTerminalPrivateKey> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = authorizeStripeTerminal_0ValidateBeforeCall(appId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<RestApiResultStripeTerminalPrivateKey>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    /**
     * Build call for initiateKioskUpdateInstallForBluetoothTerminal
     * @param appId  (required)
     * @param deviceId  (required)
     * @param terminalType  (required)
     * @param progressListener Progress listener
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call initiateKioskUpdateInstallForBluetoothTerminalCall(String appId, String deviceId, String terminalType, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call initiateKioskUpdateInstallForBluetoothTerminalValidateBeforeCall(String appId, String deviceId, String terminalType, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'appId' is set
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling initiateKioskUpdateInstallForBluetoothTerminal(Async)");
        }
        
        // verify the required parameter 'deviceId' is set
        if (deviceId == null) {
            throw new ApiException("Missing the required parameter 'deviceId' when calling initiateKioskUpdateInstallForBluetoothTerminal(Async)");
        }
        
        // verify the required parameter 'terminalType' is set
        if (terminalType == null) {
            throw new ApiException("Missing the required parameter 'terminalType' when calling initiateKioskUpdateInstallForBluetoothTerminal(Async)");
        }
        

        com.squareup.okhttp.Call call = initiateKioskUpdateInstallForBluetoothTerminalCall(appId, deviceId, terminalType, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void initiateKioskUpdateInstallForBluetoothTerminal(String appId, String deviceId, String terminalType) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> initiateKioskUpdateInstallForBluetoothTerminalWithHttpInfo(String appId, String deviceId, String terminalType) throws ApiException {
        com.squareup.okhttp.Call call = initiateKioskUpdateInstallForBluetoothTerminalValidateBeforeCall(appId, deviceId, terminalType, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call initiateKioskUpdateInstallForBluetoothTerminalAsync(String appId, String deviceId, String terminalType, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = initiateKioskUpdateInstallForBluetoothTerminalValidateBeforeCall(appId, deviceId, terminalType, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
