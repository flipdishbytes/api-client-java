...
public class CardReadersApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getReaderCall(String readerId, String appId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getReaderValidateBeforeCall(String readerId, String appId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'readerId' is set
        if (readerId == null) {
            throw new ApiException("Missing the required parameter 'readerId' when calling getReader(Async)");
        }
        
        // verify the required parameter 'appId' is set
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling getReader(Async)");
        }
        

        com.squareup.okhttp.Call call = getReaderCall(readerId, appId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public RestApiResultCardReader getReader(String readerId, String appId) throws ApiException {
        ApiResponse<RestApiResultCardReader> resp = getReaderWithHttpInfo(readerId, appId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RestApiResultCardReader> getReaderWithHttpInfo(String readerId, String appId) throws ApiException {
        com.squareup.okhttp.Call call = getReaderValidateBeforeCall(readerId, appId, null, null);
        Type localVarReturnType = new TypeToken<RestApiResultCardReader>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getReaderAsync(String readerId, String appId, final ApiCallback<RestApiResultCardReader> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getReaderValidateBeforeCall(readerId, appId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<RestApiResultCardReader>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
