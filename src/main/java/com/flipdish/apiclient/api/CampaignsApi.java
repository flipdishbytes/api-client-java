...
public class CampaignsApi {
    ...
    /**
     * Build call for fetchLoyaltyCampaignByPublicId
     * @param appId  (required)
     * @param campaignPublicId  (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call fetchLoyaltyCampaignByPublicIdCall(String appId, UUID campaignPublicId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v1.0/{appId}/campaigns/loyalty/publicId/{campaignPublicId}"
            .replaceAll("\\{" + "appId" + "\\}", apiClient.escapeString(appId.toString()))
            .replaceAll("\\{" + "campaignPublicId" + "\\}", apiClient.escapeString(campaignPublicId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call fetchLoyaltyCampaignByPublicIdValidateBeforeCall(String appId, UUID campaignPublicId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'appId' is set
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling fetchLoyaltyCampaignByPublicId(Async)");
        }
        
        // verify the required parameter 'campaignPublicId' is set
        if (campaignPublicId == null) {
            throw new ApiException("Missing the required parameter 'campaignPublicId' when calling fetchLoyaltyCampaignByPublicId(Async)");
        }
        

        com.squareup.okhttp.Call call = fetchLoyaltyCampaignByPublicIdCall(appId, campaignPublicId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public RestApiArrayResultLoyaltyCampaign fetchLoyaltyCampaignByPublicId(String appId, UUID campaignPublicId) throws ApiException {
        ApiResponse<RestApiArrayResultLoyaltyCampaign> resp = fetchLoyaltyCampaignByPublicIdWithHttpInfo(appId, campaignPublicId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RestApiArrayResultLoyaltyCampaign> fetchLoyaltyCampaignByPublicIdWithHttpInfo(String appId, UUID campaignPublicId) throws ApiException {
        com.squareup.okhttp.Call call = fetchLoyaltyCampaignByPublicIdValidateBeforeCall(appId, campaignPublicId, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call fetchLoyaltyCampaignByPublicIdAsync(String appId, UUID campaignPublicId, final ApiCallback<RestApiArrayResultLoyaltyCampaign> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = fetchLoyaltyCampaignByPublicIdValidateBeforeCall(appId, campaignPublicId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<RestApiArrayResultLoyaltyCampaign>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
