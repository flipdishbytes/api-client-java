...
public class ApmApi {
     ...
     */
    public com.squareup.okhttp.Call getApmStatusCall(String appId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v1.0/{appId}/apm/status"
    ...
    private com.squareup.okhttp.Call getApmStatusValidateBeforeCall(String appId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'appId' is set
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling getApmStatus(Async)");
        }
        

        com.squareup.okhttp.Call call = getApmStatusCall(appId, progressListener, progressRequestListener);
        return call;
     ...
     */
    public RestApiResultApmStatus getApmStatus(String appId) throws ApiException {
        ApiResponse<RestApiResultApmStatus> resp = getApmStatusWithHttpInfo(appId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RestApiResultApmStatus> getApmStatusWithHttpInfo(String appId) throws ApiException {
        com.squareup.okhttp.Call call = getApmStatusValidateBeforeCall(appId, null, null);
        Type localVarReturnType = new TypeToken<RestApiResultApmStatus>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call getApmStatusAsync(String appId, final ApiCallback<RestApiResultApmStatus> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getApmStatusValidateBeforeCall(appId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<RestApiResultApmStatus>(){}.getType();
