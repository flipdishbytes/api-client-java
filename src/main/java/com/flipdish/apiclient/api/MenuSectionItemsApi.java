...
public class MenuSectionItemsApi {
    ...
    /**
     * Build call for createMenuSectionItemFromProducts
     * @param menuId Menu identifier (required)
     * @param menuSectionId Menu section identifier (required)
     * @param createFromProducts Menu section item (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call createMenuSectionItemFromProductsCall(Integer menuId, Integer menuSectionId, CreateMenuSectionItemFromProducts createFromProducts, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = createFromProducts;

        // create path and map variables
        String localVarPath = "/api/v1.0/menus/{menuId}/sections/{menuSectionId}/sectionitems/add-products"
            .replaceAll("\\{" + "menuId" + "\\}", apiClient.escapeString(menuId.toString()))
            .replaceAll("\\{" + "menuSectionId" + "\\}", apiClient.escapeString(menuSectionId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call createMenuSectionItemFromProductsValidateBeforeCall(Integer menuId, Integer menuSectionId, CreateMenuSectionItemFromProducts createFromProducts, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'menuId' is set
        if (menuId == null) {
            throw new ApiException("Missing the required parameter 'menuId' when calling createMenuSectionItemFromProducts(Async)");
        }
        
        // verify the required parameter 'menuSectionId' is set
        if (menuSectionId == null) {
            throw new ApiException("Missing the required parameter 'menuSectionId' when calling createMenuSectionItemFromProducts(Async)");
        }
        
        // verify the required parameter 'createFromProducts' is set
        if (createFromProducts == null) {
            throw new ApiException("Missing the required parameter 'createFromProducts' when calling createMenuSectionItemFromProducts(Async)");
        }
        

        com.squareup.okhttp.Call call = createMenuSectionItemFromProductsCall(menuId, menuSectionId, createFromProducts, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Object createMenuSectionItemFromProducts(Integer menuId, Integer menuSectionId, CreateMenuSectionItemFromProducts createFromProducts) throws ApiException {
        ApiResponse<Object> resp = createMenuSectionItemFromProductsWithHttpInfo(menuId, menuSectionId, createFromProducts);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Object> createMenuSectionItemFromProductsWithHttpInfo(Integer menuId, Integer menuSectionId, CreateMenuSectionItemFromProducts createFromProducts) throws ApiException {
        com.squareup.okhttp.Call call = createMenuSectionItemFromProductsValidateBeforeCall(menuId, menuSectionId, createFromProducts, null, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Create menu section items from a list of Products (asynchronously)
     * BETA - this endpoint is under development, do not use it in your production system
     * @param menuId Menu identifier (required)
     * @param menuSectionId Menu section identifier (required)
     * @param createFromProducts Menu section item (required)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call createMenuSectionItemFromProductsAsync(Integer menuId, Integer menuSectionId, CreateMenuSectionItemFromProducts createFromProducts, final ApiCallback<Object> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createMenuSectionItemFromProductsValidateBeforeCall(menuId, menuSectionId, createFromProducts, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
