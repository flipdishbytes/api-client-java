...
public class AddressApi {
    ...
    /**
     * Build call for addressTemplates
     ...
     */
    public com.squareup.okhttp.Call addressTemplatesCall(StoreAddressForm address, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = address;

        // create path and map variables
        String localVarPath = "/api/v1.0/address/templates";
    ...
    private com.squareup.okhttp.Call addressTemplatesValidateBeforeCall(StoreAddressForm address, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'address' is set
        if (address == null) {
            throw new ApiException("Missing the required parameter 'address' when calling addressTemplates(Async)");
        }
        

        com.squareup.okhttp.Call call = addressTemplatesCall(address, progressListener, progressRequestListener);
        return call;
     ...
     */
    public RestApiStringResult addressTemplates(StoreAddressForm address) throws ApiException {
        ApiResponse<RestApiStringResult> resp = addressTemplatesWithHttpInfo(address);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RestApiStringResult> addressTemplatesWithHttpInfo(StoreAddressForm address) throws ApiException {
        com.squareup.okhttp.Call call = addressTemplatesValidateBeforeCall(address, null, null);
     ...
     */
    public com.squareup.okhttp.Call addressTemplatesAsync(StoreAddressForm address, final ApiCallback<RestApiStringResult> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = addressTemplatesValidateBeforeCall(address, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<RestApiStringResult>(){}.getType();
    ...
    /**
     * Build call for validateAddressForm
     * @param address  (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call validateAddressFormCall(StoreAddressForm address, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = address;

        // create path and map variables
        String localVarPath = "/api/v1.0/address/validate";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call validateAddressFormValidateBeforeCall(StoreAddressForm address, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'address' is set
        if (address == null) {
            throw new ApiException("Missing the required parameter 'address' when calling validateAddressForm(Async)");
        }
        

        com.squareup.okhttp.Call call = validateAddressFormCall(address, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public RestApiStringResult validateAddressForm(StoreAddressForm address) throws ApiException {
        ApiResponse<RestApiStringResult> resp = validateAddressFormWithHttpInfo(address);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RestApiStringResult> validateAddressFormWithHttpInfo(StoreAddressForm address) throws ApiException {
        com.squareup.okhttp.Call call = validateAddressFormValidateBeforeCall(address, null, null);
        Type localVarReturnType = new TypeToken<RestApiStringResult>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call validateAddressFormAsync(StoreAddressForm address, final ApiCallback<RestApiStringResult> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = validateAddressFormValidateBeforeCall(address, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<RestApiStringResult>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
