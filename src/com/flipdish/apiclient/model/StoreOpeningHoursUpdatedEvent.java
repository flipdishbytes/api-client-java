...
public class StoreOpeningHoursUpdatedEvent implements Serializable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(eventName, storeId, user, description, flipdishEventId, createTime, position, appId);
  }
