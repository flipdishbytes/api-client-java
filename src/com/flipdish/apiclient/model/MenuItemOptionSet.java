...
public class MenuItemOptionSet implements Serializable {
  ...
  **/
  ...
  public MenuItemOptionSet addMenuItemOptionSetItemsItem(MenuItemOptionSetItem menuItemOptionSetItemsItem) {
    if (this.menuItemOptionSetItems == null) {
      this.menuItemOptionSetItems = new ArrayList<>();
    }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(menuItemOptionSetId, imageUrl, menuItemOptionSetItems, publicId, name, isMasterOptionSet, displayOrder, minSelectCount, maxSelectCount, cellLayoutType);
  }
