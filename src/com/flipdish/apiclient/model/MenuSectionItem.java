...
public class MenuSectionItem implements Serializable {
   ...
   * @return menuItemId
  **/
  @ApiModelProperty(value = "Menu item identifier. This ID may change at any time. Use `PublicId` if you need a perminant reference to the item.")
  ...
  **/
  ...
  public MenuSectionItem addMenuItemOptionSetsItem(MenuItemOptionSet menuItemOptionSetsItem) {
    if (this.menuItemOptionSets == null) {
      this.menuItemOptionSets = new ArrayList<>();
    }
  ...
  **/
  ...
  public MenuSectionItem addDailySpecialHoursItem(BusinessHoursPeriod dailySpecialHoursItem) {
    if (this.dailySpecialHours == null) {
      this.dailySpecialHours = new ArrayList<>();
    }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(menuItemId, actualPrice, imageUrl, menuItemOptionSets, dailySpecialHours, publicId, name, description, spicinessRating, price, displayOrder, alcohol, isAvailable, cellLayoutType, disableVouchers);
  }
