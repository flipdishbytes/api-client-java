...
public class LightspeedSettings implements Serializable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(companyId, enabled, estimatedMinutesForDelivery, estimatedMinutesForCollection, geographicLocation, establishment, voucherId, deliveryFeeId, processingFeeId, priceType, menuId);
  }
