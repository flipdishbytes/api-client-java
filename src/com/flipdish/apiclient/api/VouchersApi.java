...
public class VouchersApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateVoucherCall(Integer voucherId, VoucherBase voucher, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateVoucherValidateBeforeCall(Integer voucherId, VoucherBase voucher, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateVoucherCall(voucherId, voucher, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public RestApiResultVoucherWithStats updateVoucher(Integer voucherId, VoucherBase voucher) throws ApiException {
        ApiResponse<RestApiResultVoucherWithStats> resp = updateVoucherWithHttpInfo(voucherId, voucher);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RestApiResultVoucherWithStats> updateVoucherWithHttpInfo(Integer voucherId, VoucherBase voucher) throws ApiException {
        com.squareup.okhttp.Call call = updateVoucherValidateBeforeCall(voucherId, voucher, null, null);
        Type localVarReturnType = new TypeToken<RestApiResultVoucherWithStats>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateVoucherAsync(Integer voucherId, VoucherBase voucher, final ApiCallback<RestApiResultVoucherWithStats> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateVoucherValidateBeforeCall(voucherId, voucher, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<RestApiResultVoucherWithStats>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
