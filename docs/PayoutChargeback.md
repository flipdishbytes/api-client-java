...
------------ | ------------- | ------------- | -------------
**orderId** | **Integer** | The id of the order the chargeback was for |  [optional]
...
**chargebackDate** | [**OffsetDateTime**](OffsetDateTime.md) | The date the chargeback was done |  [optional]
