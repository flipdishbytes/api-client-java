...
------------ | ------------- | ------------- | -------------
**channel** | [**ChannelEnum**](#ChannelEnum) | The order channel this fee config applies to |  [optional]
**paymentMethod** | [**PaymentMethodEnum**](#PaymentMethodEnum) | The payment method this fee config applies to |  [optional]
