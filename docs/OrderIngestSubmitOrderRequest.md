...
------------ | ------------- | ------------- | -------------
**appType** | [**AppTypeEnum**](#AppTypeEnum) | [Required] Indicated the name from where the request is coming from |  [optional]
**storeId** | **Integer** | [Required] Store Id |  [optional]
**currencyCode** | [**CurrencyCodeEnum**](#CurrencyCodeEnum) | [Required] Currency Code  These must match three letter codes ISO 4127 http://en.wikipedia.org/wiki/ISO_4217 |  [optional]
...
**orderDateUtc** | [**OffsetDateTime**](OffsetDateTime.md) | Date the order was placed at in UTC  [Required] |  [optional]
