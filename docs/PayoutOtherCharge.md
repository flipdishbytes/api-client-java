...
------------ | ------------- | ------------- | -------------
**chargeId** | **Integer** | The id of the charge |  [optional]
**amount** | **Double** | Charge amount |  [optional]
**currency** | [**CurrencyEnum**](#CurrencyEnum) | Currency of the charge |  [optional]
**payoutId** | **Integer** | The id of the payout the order is related to |  [optional]
**chargeDate** | [**OffsetDateTime**](OffsetDateTime.md) | The date the order was placed |  [optional]
**chargeType** | [**ChargeTypeEnum**](#ChargeTypeEnum) | Charge type |  [optional]
